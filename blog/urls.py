...
urlpatterns = [
    ...
    path("/posts/<slug: slug>", views.post_detail, name="post-detail-page") #Same way we have the int and str transformers, we have the slug transformer which will look for and apply the sintax "/characters-and-or-numbers". Again, slug is a broadly name to refer to the dynamic segment that carries on the value which will ultimately be use as a parameter from our view 
]